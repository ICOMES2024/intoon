...
<section class="container registration registration_rating_guides app_version">
	<!-- HUBDNCLHJ : app 메뉴 탭 -->

	<div class="app_title_box">
		<h2 class="app_title">CME Credits (Korean Only)<button type="button" class="app_title_prev" onclick="javascript:window.location.href='./app_index.php';"><img src="https://image.webeon.net/icomes2024/app/2024_icon_arrow_prev_wh.svg" alt="이전페이지로 이동"></button></h2>
	</div>

	<h1 class="page_title">CME Credits</h1>
	<div class="inner">
		...
		<div class="details">
			...
			<div class="mt10">
				<ul class="indent_ul">
					...
					<li class="purple_txt bold">• 내과분과전공의 시험/갱신 평점은 체류 시간 상관없이 참석 확인 시 1평점이 부여됩니다.</li>
				</ul>
			</div>
		</div>
		</div> 
