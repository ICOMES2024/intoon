...
<section class="container registration registration_rating_guides app_version">
	...
	<div class="app_title_box">
		<h2 class="app_title">평점 안내<button type="button" class="app_title_prev" onclick="javascript:window.location.href='./app_index.php';"><img src="https://image.webeon.net/icomes2024/app/2024_icon_arrow_prev_wh.svg" alt="이전페이지로 이동"></button></h2>
	</div>
				...
				<table class="c_table2 detail_table center">
					...
					<tbody>
						...
						<tr>
							...
							<td>없음</td>
							<td colspan="2">최대 2평점 <span class="red_t bold">(예정)</span><!--br/><span class="font_small">* 오전 3시간, 오후 3시간 참석 시 각 1점 부여</span--></td>
						</tr>
						<tr>
