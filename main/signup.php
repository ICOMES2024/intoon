...
<style>
	...
	.korea_only, .korea_radio, .non_korea_only, .non_korea_radio{
		display:none;
	}
	.korea_only.on, .korea_radio.on, .non_korea_only.on, .non_korea_radio.on{
		display:revert;
	}
	.mo_korea_only, .korea_radio, .mo_non_korea_only{
		display:none;
	}
	.mo_korea_only.on, .korea_radio.on, .mo_non_korea_only.on{
		display:revert;
	}
	...
	$(document).ready(function(){
		...
		$("select[name=nation_no]").change(function(){
			...
			if (value == 25){
				...
				//[240703] sujeong / 해외 멤버인증 추가
				$(".non_korea_radio").removeClass("on");
				$(".non_korea_only").removeClass("on");
				$(".non_ksola_signup").removeClass("on");
	...
	$(document).ready(function(){
		...
		$("select[name='mo_nation_no']").change(function(){
			...
			if (value == 25){
				...
				$(".mo_non_korea_radio").removeClass("on");
				$(".mo_non_korea_only").removeClass("on");
				$(".mo_non_ksola_signup").removeClass("on")
			}else {
		...
		<form class="table_wrap">
				...
				<table class="table detail_table">
					...
					<tbody>
						...
						<tr class="non_korea_radio">
							<th class="nowrap"><span class="red_txt">*</span>KSSO Membership Status<br/><span class="font_small">(Korean Society for the Study of Obesity)</span></th>
							<td>
								<div class="label_wrap">
									<input checked type="radio" class="new_radio" name="user_non_korea" id="user3">
									<label for="user3"><i></i>Member</label>	
									
									<input type="radio" class="new_radio" name="user_non_korea" id="user4">
						...
						<tr class="non_ksola_signup">
							...
							<div class=" mt20">
										...
										<div class="clearfix2">
											...
											<!-- 외국 사이트 id/pw 찾기 -->
											<a href="https://eng.kosso.or.kr/account/find_info.php" target="_blank" class="id_pw_find center_t">Find KSSO membership ID/PW</a>
										</div>
			...
			<div class="mb_only">
				<ul class="sign_list">
					...
					<li class="non_korea_radio mo_non_korea_radio">
						<p class="label"><span class="red_txt">*</span>KSSO Membership Status<br/><span class="font_small">(Korean Society for the Study of Obesity)</span></p>
						<div class="label_wrap">
							<input checked type="radio" class="new_radio" name="mo_user1" id="mo_user3">
							<label for="mo_user3"><i></i>Member</label>	
					...
					<li class="korea_radio mo_korea_radio">
						...
						<div class="label_wrap">
							...
							<span class="red_t"><br/>* 대한비만학회 회원이 아닐 경우,<br/>비회원을 선택해 주시기 바랍니다.</span>	
						</div>
					</li>
