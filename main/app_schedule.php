...
<section class="container app_version app_scientific">
	...
	<div class="contents_box">
		<div class="sponsor_grade schedule_area">
			<a href="javascript:;" class="grade_title deep_skyblue_bg">Day 1 / September 5 (Thu)</a>
			<ul class="program_detail_ul">
                ...
                foreach ($resultObj as $program){
                    ...
                    if($program['program_date']==='2024-09-05'){
                    ?>
                    <li name="">
                        <div class="main">
                            <?php
			...
			<a href="javascript:;" class="grade_title deep_blue_bg">Day 2 / September 6 (Fri)</a>
			<ul class="program_detail_ul">
                <?php
                foreach ($resultObj as $program){
                    if($program['schedule_check']==='Y'){
                    ...
                    if($program['program_date']==='2024-09-06'){
                        ?>
                        <li name="">
                            <div class="main">
                                <?php
			...
			<a href="javascript:;" class="grade_title deep_purple_bg">Day 3 / September 7 (Sat)</a>
			<ul class="program_detail_ul">
                <?php
                foreach ($resultObj as $program){
                    if($program['schedule_check']==='Y'){
                    ...
                    if($program['program_date']==='2024-09-07'){
                        ?>
                        <li name="">
                            <div class="main">
                                <?php
